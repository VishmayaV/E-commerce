          ...
          <div className="d-flex flex-column justify-content-center ">
            <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                  ...
                  <p className='mb-3'>Save more today with QuickBox</p>
    ...
    <div className="row">
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text"> The quality is top-notch, and it has made my daily routine so much easier. Highly recommend!</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">It's worth every penny, and the features are exactly as advertised. Will definitely buy again.</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">It's reliable and works perfectly every time. Plus, the customer support team is fantastic and very accommodating.</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">The craftsmanship and attention to detail are evident, and it's incredibly user-friendly.</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
